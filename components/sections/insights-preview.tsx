...
import { InsightSignalBoard } from '@/components/sections/insight-signal-board';

export function InsightsPreview() {
  return (
    <section data-chapter="Insights" className="section-shell bg-surface/55">
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(370px,.8fr)] lg:gap-12 xl:gap-16">
          <Reveal>
            <SectionHeading
          ...
          <div>
            ...
            <Reveal
              delay={0.16}
              className="mt-6 flex lg:justify-end"
            >
